    ...
    if (jQuery.browser)
    {
        $(window).on("load resize", function() {
            ...
            if (w > 700 & w < 900) {
                ...
                $("#principal").css('background', 'url(css/images/MCDS2.png) no-repeat');
                $("#principal").css('width', '350px');
                $("#principal").css('height', '100px');
                $("#pieLogo").css('background', 'url(css/images/SIISE-30x35.png)');
                $("#pieLogo").css('width', '30px');
                $("#pieLogo").css('height', '35px');
