            ...
            success: function(data) {
                ...
                $.getJSON(cadena, function(result) {
                    ...
                    if (w > 640) {
                        ...
                        $('#estilo_ind_general').remove();
                        $('#estilo_inf_general').remove();
                        $('#estilo_inf_ciclo').remove();
                    }
                    else {
                        $('head').append('<style id="estilo_ind_general">'
                                + '#ind_general td:nth-of-type(2):before { content: "' + nombre_prv + '"; }'
                                + '#ind_general td:nth-of-type(3):before { content: " "; }'
                                + '#ind_general td:nth-of-type(4):before { content: "' + nombre_ciu + '"; }'
                                + '#ind_general td:nth-of-type(5):before { content: " "; }'
                                + '</style>');

                        $('head').append('<style id="estilo_inf_general">'

                                + '#inf_general td:nth-of-type(2):before { content: "' + nombre_prv + '"; }'
                                + '#inf_general td:nth-of-type(3):before { content: "' + nombre_ciu + '"; }'
                                + '</style>');

                        $('head').append('<style id="estilo_inf_ciclo">'

                                + '#inf_ciclo td:nth-of-type(2):before { content: "' + nombre_prv + '"; }'
                                + '#inf_ciclo td:nth-of-type(3):before { content: "' + nombre_ciu + '"; }'
                                + '</style>');
                    }
